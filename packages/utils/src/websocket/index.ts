...
export class WebSocketClient extends EventDispatcher {
	...
	// #重连间隔
	private reconnectInterval = 5000; // 10 seconds
	// #发送心跳数据间隔
	private heartbeatInterval = 5000;
	private heartbeatTimeoutInterval = 5000;
	// #计时器id
	...
	private closeHeartbeat(): void {
		...
		clearInterval(this.heartbeatTimeoutTimer as NodeJS.Timeout);
